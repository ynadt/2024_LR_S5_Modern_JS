...
const RegisterPage = () => {
    ...
    const handleRegister = async (e) => {
        ...
        if (!validatePassword(password)) {
            setPasswordError('Password must contain at least one uppercase letter, one lowercase letter, one number, and only English letters.');
            return;
        } else {
            setPasswordError('');
        }
            ...
            <main className={styles.main}>
                <div className={styles.container}>
                    ...
                    <form onSubmit={handleRegister} className={styles.form}>
                        ...
                        <Button type="submit" disabled={!isFormValid || isRegistering} className={styles.submitButton}>
                    ...
                    <Button onClick={handleGoogleRegister} className={styles.googleButton} disabled={isRegistering}>
